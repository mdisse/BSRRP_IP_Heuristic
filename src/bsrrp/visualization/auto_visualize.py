...
def visualize_result_async(result_file: str, overwrite: bool = True, 
    ...
    timestep_script = os.path.join(script_dir, 'visualization', 'visualize_BSRRP_steps.py')
    astar_script = os.path.join(script_dir, 'visualization', 'visualize_astar_moves.py')
