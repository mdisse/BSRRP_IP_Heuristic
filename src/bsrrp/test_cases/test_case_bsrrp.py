...
from bsrrp.test_cases.writer_functions import save_resultsBsrrp
...
class TestCaseBsrrp: 
    ...
    def solve_heuristic_vrp(self, time_limit=None, solver='scheduling'):
        ...
        from bsrrp.heuristics.twvrp import solve_twvrp
    ...
    def save_heuristic_results(self, instance_file_path: str, fleet_size_override=None, validate=True):
        ...
        from bsrrp.test_cases.writer_functions import save_heuristic_results, generate_heuristic_filename
...
if __name__ == "__main__": 
    from bsrrp.examples_gen.unit_load_gen import UnitLoadGenerator
